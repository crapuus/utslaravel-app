...
<div class="container">
    <h1>{{ __('Karyawan') }}</h1>
    <form method="post" action="{{ url('/karyawan/update/' . $karyawan->id ) }}" class="form-horizontal">
        @csrf
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" id="pendidikan_terakhir" name="pendidikan_terakhir" value="{{ old('pendidikan_terakhir') ?? $karyawan->pendidikan_terakhir }}">
            </div>
        </div>
